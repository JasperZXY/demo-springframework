...
import org.ruanwei.demo.springframework.core.ioc.databinding.PeopleFormatterRegistrar3;
...
public class AppConfig3 {
	private static Log log = LogFactory.getLog(AppConfig3.class);
	...
	@Inject
	@Resource
	private Environment env;// 为什么无法自动注入

	@Bean("conversionService")
	public FormattingConversionServiceFactoryBean conversionService() {
		FormattingConversionServiceFactoryBean conversionService = new FormattingConversionServiceFactoryBean();
		PeopleFormatterRegistrar3 formatterRegistrar = new PeopleFormatterRegistrar3();
