...
public class RedisClient {
	...
	public void testRedisHash() {
		...
		user = (User) mapper.fromHash(loadedHash);
		log.info("user=" + user);

		HashMapper<User, String, String> mapper2 = new BeanUtilsHashMapper<User>(
				User.class);
		User user2 = new User("ruanwei2", 33);
		...
		user2 = (User) mapper2.fromHash(loadedHash2);
