...
public class PeopleSpringValidator3 implements Validator {
	private static Log log = LogFactory.getLog(PeopleSpringValidator3.class);

	@Override
	public boolean supports(Class<?> clazz) {
		log.info("supports(Class<?> clazz)" + clazz);
		return People3.class.equals(clazz);
	}
