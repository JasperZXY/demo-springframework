...
public class MyAspect3 implements Ordered {
	private static Log log = LogFactory.getLog(MyAspect3.class);
	...
	@DeclareParents(value = "org.ruanwei.demo.springframework.core.aop.GoodImpl3", defaultImpl = HappyImpl3.class)
	public static Happy3 mixin;
