...
@Lazy
@Component("father")
public class People3 implements SmartLifecycle {
	private static Log log = LogFactory.getLog(People3.class);
	...
	public People3(@Value("${father.name:ruan_wei}") String name, @Value("${father.age:34}") int age) {
		this.name = name;
		this.age = age;
		log.info("People3(String name,int age)" + this);
	}
	...
	public String toString() {
		return "People3 [name=" + name + ", age=" + age + "]";
	}
